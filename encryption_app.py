...
def main_screen():
    ...
    Label(text="Enter your secrete key",fg="black",font=("calibri",13)).place(x=10,y=170)
    
    code=StringVar()
    Entry(textvariable=code,width=21,bd=0,font=("arial",25),show="*").place(x=10,y=200)
